...
class Frontend {
    ...
    public function fffl_submit_enrollment(): void {
        ...
        try {
            ...
            // through - the same failure fffl_book_appointment had.
    ...
    private function send_confirmation_email(array $instance, array $form_data, string $confirmation_number): void {
        ...
        $schedule_date = \FFFL\Utilities::getAppointmentDateDisplay($raw_date) ?: $raw_date;
        $schedule_time = \FFFL\Utilities::getTimeSlotDisplay($raw_time) ?: $raw_time;
...
<body style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;background-color:#f4f4f4;">
    ...
    private function get_time_display(string $time): string {
        return \FFFL\Utilities::getTimeSlotDisplay($time) ?: $time;
    }
